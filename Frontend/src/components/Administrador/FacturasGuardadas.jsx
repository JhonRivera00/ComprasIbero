...
import { facturaVista, facturasGuardadas, facturasTotales } from "../../services/acopiadores.services";
...
function Facturas() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setIsLoading(true);
      const facturasT = await facturasGuardadas();
                  ...
                  <div className={`row fila w-100 ${factura.visto === true ? "" : "bg-dark-subtle"}`} key={factura._id}>
                    ...
                    <div className="col-2 content-table1 container-opciones content-table1">
                      <div className="container container-opciones content-table1">
                        ...
                        <button className="btn" title="Guardar"><i className="bi bi-floppy"></i></button>
                      </div>
                    </div>
                  </div>
